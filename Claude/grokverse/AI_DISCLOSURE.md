...
| Preparation material `Claude/PREP/` (study guide, jury Q&A, own-work plan) | **AI-written 2026-06-21** for the author's preparation; marked there as not part of the submission. Found on 2026-09-20 to be tracked in this repository — whether it stays is the authors' call (changelog 2026-09-20 (f)). |
...
Since 2026-08-14 the authors have been mentored, in a LinkedIn chat, by an external reviewer (a PhD-level
...
A colleague of the author (**[HUMAN AUTHORS MUST COMPLETE: name and role]**) sent an AI-generated "four-phase
